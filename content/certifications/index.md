...
<section class="py-12 px-12 text-center">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-7xl mx-auto gap-4">
    ...
    <div class="hover:scale-105 transition-transform">
      <img src="feature2.jpg" alt="Certification 2" class="rounded-xl shadow-[0_0_15px_rgba(255,0,255,0.4)] hover:shadow-[0_0_25px_rgba(0,255,255,0.7)] transition-all">
      <p class="mt-3 text-center text-sm text-gray-300">Certification 2</p>
    </div>
    <div class="hover:scale-105 transition-transform">
      <img src="feature3.jpg" alt="Certification 3" class="rounded-xl shadow-[0_0_15px_rgba(255,0,255,0.4)] hover:shadow-[0_0_25px_rgba(0,255,255,0.7)] transition-all">
    ...
    <div class="hover:scale-105 transition-transform">
      <img src="feature5.jpg" alt="Certification 5" class="rounded-xl shadow-[0_0_15px_rgba(255,0,255,0.4)] hover:shadow-[0_0_25px_rgba(0,255,255,0.7)] transition-all">
    ...
    <div class="hover:scale-105 transition-transform">
      <img src="feature7.jpg" alt="Certification 7" class="rounded-xl shadow-[0_0_15px_rgba(255,0,255,0.4)] hover:shadow-[0_0_25px_rgba(0,255,255,0.7)] transition-all">
    ...
    <div class="hover:scale-105 transition-transform">
      <img src="feature11.jpg" alt="Certification 11" class="rounded-xl shadow-[0_0_15px_rgba(255,0,255,0.4)] hover:shadow-[0_0_25px_rgba(0,255,255,0.7)] transition-all">
      <p class="mt-3 text-center text-sm text-gray-300">Certification 11</p>
    </div>
    <div class="hover:scale-105 transition-transform">
      <img src="feature12.pdf" alt="Certification 12" class="rounded-xl shadow-[0_0_15px_rgba(255,0,255,0.4)] hover:shadow-[0_0_25px_rgba(0,255,255,0.7)] transition-all">
      <p class="mt-3 text-center text-sm text-gray-300">Certification 12</p>
    </div>
  </div>
</section>
</div>
